            ...
            <JetDialogModal :show="openMessage" @close="openMessage = !openMessage">
                ...
                <template #content>
                    ...
                    <div class="w-full rounded-lg bg-white overflow-hidden  block ">
                        ...
                        <div class="mt-4 border rounded-md md:flex p-4 w-full text-gray-900 hover:bg-gray-50 cursor-pointer">
                            <div class="w-14">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            ...
                            <div class="flex-1 font-semibold">
                                <div>
                                    <h5>Facture: {{order[0].order_key}}.pdf</h5>
                                    <small> La derniere version de la facture en Pdf sera aussi attache.</small>
                                </div>
